...
public class AddUserToGroupHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public AddUserToGroupHandler() {
        userPoolId = Utils.decryptKey("MY_COGNITO_POOL_ID");
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        try {
            ...
            JsonObject addUserToUserGroupResult = cognitoUserService.addUserToGroup(groupName, userName, userPoolId);
            response.withBody(new Gson().toJson(addUserToUserGroupResult, JsonObject.class));
